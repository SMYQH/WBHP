    ...
    <div className="relative min-h-screen text-gray-900 dark:text-gray-100">
      ...
      <div className="fixed top-4 right-4 z-40 flex items-center gap-2">
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-full bg-white/20 backdrop-blur transition-colors duration-200 hover:bg-white/30 dark:bg-white/10 dark:hover:bg-white/20 shadow-sm border border-white/10 focus-visible:ring-2 focus-visible:ring-emerald-400"
        ...
        <button
          type="button"
          onClick={toggleZen}
          className={`flex h-11 w-11 items-center justify-center rounded-full backdrop-blur transition-colors duration-200 shadow-sm border focus-visible:ring-2 focus-visible:ring-emerald-400 ${
            isZenMode
